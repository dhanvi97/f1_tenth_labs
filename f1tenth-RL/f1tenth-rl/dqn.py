...
class DeepQNetwork:
    ...
    def inference(self, state):
        ...
        infered_action = np.asarray(self.behavior_predict(state)).argmax(axis=1)
        return infered_action[0]
    ...
    def save_network(self):
        print("saving..")
        self.target_net.save_weights(self.checkpoint_dir + 'model_' + str(self.checkpoint_count) + '.h5', save_format='h5')
        print('saved weights')
